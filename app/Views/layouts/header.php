...
<head>
  ...
  <style>
    ...
    .header-wrapper { display: flex; align-items: center; justify-content: space-between; padding: 15px 40px; gap: 20px; max-width: 1400px; margin: 0 auto; box-sizing: border-box; }
    ...
    /* شريط البحث المطور */
    .search-box-container { flex: 1; max-width: 500px; }
    ...
    @media (max-width: 800px) {
        .header-wrapper { flex-wrap: wrap; padding: 15px 20px !important; gap: 15px; }
        ...
        .search-box-container { order: 3; width: 100%; max-width: 100%; }
        .nav_toggle { order: 1; font-size: 26px !important; color: var(--main-color) !important; cursor: pointer; margin: 0 !important; }
        .logo-container { order: 2; margin-right: auto; }
        .nav_logo { max-height: 40px !important; width: auto !important; }
        
        /* تدمير لون القائمة القديم وفرض الشكل الأبيض النظيف */
        .nav_menu { 
        ...
        .nav_menu_close { position: absolute !important; top: 20px !important; left: 20px !important; color: #ef4444 !important; font-size: 24px !important; }
        ...
        .nav-list { padding: 15px 20px !important; margin: 0 !important; flex-direction: column !important; width: 100% !important; box-sizing: border-box !important; }
        .nav_link { 
        ...
        .nav_link.active { color: var(--main-color) !important; padding-right: 20px !important; }
    }
  </style>
</head>
...
<body>
  <header class="master-header" id="header">
    <div class="header-wrapper">
      ...
      <!-- 1. زر الموبايل (يظهر في الموبايل فقط) -->
      ...
      <!-- 4. أيقونات الكمبيوتر (تختفي في الموبايل) -->
      ...
      <!-- 5. القائمة (جانبية للموبايل / أفقية للكمبيوتر) -->
